...
userRouter.post("",middlewares.validateBody(userCreateSchema) ,middlewares.validateEmailExists,userControllers.create)
userRouter.get("",middlewares.validateToken,middlewares.validateAdmin,userControllers.read)

userRouter.use("/:userId",middlewares.validateToken,middlewares.verifyUser,middlewares.validateIdExists)
